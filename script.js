...
function handleSubmit(event, form) {
  ...
  setTimeout(() => {
    form.innerHTML = `
      <div style="text-align: center; padding: 40px 10px; animation: fadeInUp 0.6s ease forwards;">
        <svg xmlns="http://www.w3.org/2000/svg" width="72" height="72" fill="#1a6e3c" viewBox="0 0 24 24" style="margin-bottom: 24px;">
          <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 15l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z"/>
        </svg>
        <h3 style="color: var(--navy-deep); font-family: 'Cormorant Garamond', serif; font-size: 2.2rem; margin-bottom: 12px;">Message Sent!</h3>
        <p style="color: var(--text-muted); font-size: 1.1rem; line-height: 1.6;">Thank you for choosing Majestic Cleaning. We have received your request and will contact you shortly.</p>
      </div>
    `;
  }, 1500);
}
...
(function () {
  ...
  const SERVICES = {
    carpet: {
      ...
      before: 'imagens/carpet-before.webp',
      after:  'imagens/carpet-after.webp',
      desc: `
        <h4>What Is It</h4>
    ...
    upholstery: {
      ...
      before: 'imagens/upholstery-before.webp',
      after:  'imagens/upholstery-after.webp',
      desc: `
        <h4>What Is It</h4>
    ...
    home: {
      ...
      before: 'imagens/home-before.webp',
      after:  'imagens/home-after.webp',
      desc: `
        <h4>What Is It</h4>
    ...
    deep: {
      ...
      before: 'imagens/deep-before.webp',
      after:  'imagens/deep-after.webp',
      desc: `
        <h4>What Is It</h4>
    ...
    moveinout: {
      ...
      before: 'imagens/move-before.webp',
      after:  'imagens/move-after.webp',
      desc: `
        <h4>What Is It</h4>
    ...
    commercial: {
      ...
      before: 'imagens/commercial-before.webp',
      after:  'imagens/commercial-after.webp',
      desc: `
        <h4>What Is It</h4>
    ...
    postconstruction: {
      ...
      before: 'imagens/construction-before.webp',
      after:  'imagens/construction-after.webp',
      desc: `
        <h4>What Is It</h4>
    ...
    car: {
      ...
      before: 'imagens/car-before.webp',
      after:  'imagens/car-after.webp',
      desc: `
        <h4>What Is It</h4>
    ...
    sanitization: {
      ...
      before: 'imagens/sanitization-before.webp',
      after:  'imagens/sanitization-after.webp',
      desc: `
        <h4>What Is It</h4>
